...
#### C# application, 07/14/2020

#### By **Evgeniya Chernaya**

## Description

This application take a user input number (allergies score) and return the list of allergens. 
...
|----------|-------|-------|
| Convert number to binary array | 10 | {0, 1, 0, 1} |
